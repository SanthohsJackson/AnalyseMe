# apps/x/apps/renderer/src/components/ui/progress.tsx

**File:** apps/x/apps/renderer/src/components/ui/progress.tsx  
**Language:** typescript

## Purpose
Render a progress bar component using Radix UI's ProgressPrimitive.
...
- ...props: React.ComponentProps<typeof ProgressPrimitive.Root> — additional properties for the root component
